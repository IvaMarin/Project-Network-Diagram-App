...
class Ui_MainWindow6(object):
    def setupUi(self, MainWindow6):
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("resources/iconePack/check-mark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow6):
        ...
        self.menuFile.setTitle(_translate("MainWindow6", "Файл"))
        self.menuHelp.setTitle(_translate("MainWindow6", "Справка"))
        self.menuEdit.setTitle(_translate("MainWindow6", "Редактор"))
        self.menu.setTitle(_translate("MainWindow6", "Настройки"))
