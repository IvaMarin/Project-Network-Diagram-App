...
class Ui_task1CheckUi(object):
    def setupUi(self, task2CheckForm):
        ...
        self.labelConnectionsCount.setFont(font)
        self.labelNodesCount.setFont(font)
        self.labelSoClose.setFont(font)
        self.labelConnectionCross.setFont(font)
        self.labelEdgesIntersect.setFont(font)
