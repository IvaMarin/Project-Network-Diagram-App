...
class Ui_task2SquadWidget(object):
    def setupUi(self, Form):
        ...
        self.label_amountSquad = QtWidgets.QLabel(self.frame)
        self.label_amountSquad.setObjectName("label_amountSquad")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.label_amountSquad)
