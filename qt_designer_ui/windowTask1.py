...
class Ui_MainWindow1(object):
    ...
    def retranslateUi(self, MainWindow1):
        ...
        self.actionbtnAddNode.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Добавить узел</span></p></body></html>"))
        self.actionbtnRemoveNode.setText(_translate("MainWindow1", "btnRemoveNode"))
        self.actionbtnRemoveNode.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Удаление узла и связей</span></p></body></html>"))
        self.actionbtnMoveNode.setText(_translate("MainWindow1", "btnMoveNode"))
        self.actionbtnMoveNode.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Передвинуть элемент</span></p></body></html>"))
        self.actionbtnConnectNode.setText(_translate("MainWindow1", "btnConnectNode"))
        self.actionbtnConnectNode.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Соединить узлы</span></p></body></html>"))
        self.actionbtnInfo.setText(_translate("MainWindow1", "btnInfo"))
        self.actionbtnInfo.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Материалы</span></p></body></html>"))
        self.actionbtnHome.setText(_translate("MainWindow1", "btnHome"))
        self.actionbtnHome.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Перейти к выбору заданий / В меню</span></p></body></html>"))
        self.actionbtnRemoveNodeConnection.setText(_translate("MainWindow1", "btnRemoveNodeСonnection"))
        self.actionbtnRemoveNodeConnection.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Удаление связей</span></p></body></html>"))
        self.actionbtnZoomIn.setText(_translate("MainWindow1", "btnZoomIn"))
        self.actionbtnZoomIn.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Увеличить изображение</span></p></body></html>"))
        self.actionbtnZoomOut.setText(_translate("MainWindow1", "btnZoomOut"))
        self.actionbtnZoomOut.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Уменьшить изображение</span></p></body></html>"))
        ...
        self.actionbtnCheck.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Проверить задание</span></p></body></html>"))
        self.actionHelp.setText(_translate("MainWindow1", "подсказка"))
        self.actionHelp.setToolTip(_translate("MainWindow1", "<html><head/><body><p><span style=\" font-size:14pt;\">Подсказка (режим преподавателя)</span></p></body></html>"))
