...
class Ui_MainWindow1(object):
    def setupUi(self, MainWindow1):
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1669, 22))
    ...
    def retranslateUi(self, MainWindow1):
        ...
        self.actionbtnAddNode.setToolTip(_translate("MainWindow1", "Добавить вершину"))
        self.actionbtnRemoveNode.setText(_translate("MainWindow1", "btnRemoveNode"))
        self.actionbtnRemoveNode.setToolTip(_translate("MainWindow1", "Удалить вершину"))
        self.actionbtnMoveNode.setText(_translate("MainWindow1", "btnMoveNode"))
        self.actionbtnMoveNode.setToolTip(_translate("MainWindow1", "Переместить вершину"))
        self.actionbtnConnectNode.setText(_translate("MainWindow1", "btnConnectNode"))
        self.actionbtnConnectNode.setToolTip(_translate("MainWindow1", "Соединить вершины"))
        ...
        self.actionbtnHome.setToolTip(_translate("MainWindow1", "В главное меню"))
        self.actionbtnRemoveNodeConnection.setText(_translate("MainWindow1", "btnRemoveNodeСonnection"))
        self.actionbtnRemoveNodeConnection.setToolTip(_translate("MainWindow1", "Удалить связь"))
        ...
        self.actionHelp.setToolTip(_translate("MainWindow1", "Решение"))
