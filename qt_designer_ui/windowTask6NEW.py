...
class Ui_MainWindow6(object):
    ...
    def retranslateUi(self, MainWindow6):
        ...
        self.actionbtnHome.setToolTip(_translate("MainWindow6", "В главное окно"))
        ...
        self.actionbtnDottedConnectNode.setToolTip(_translate("MainWindow6", "Расстановка продолжительности работ"))
        self.actionbtnMoveNode.setText(_translate("MainWindow6", "btnMoveNode"))
        self.actionbtnMoveNode.setToolTip(_translate("MainWindow6", "Переместить вершину"))
        self.actionHelp.setText(_translate("MainWindow6", "подсказка"))
        self.actionHelp.setToolTip(_translate("MainWindow6", "Решение"))
