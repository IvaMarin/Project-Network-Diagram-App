...
# Form implementation generated from reading ui file 'windowTask6.ui'
#
...
class Ui_MainWindow6(object):
    def setupUi(self, MainWindow6):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("resources/iconePack/home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnHome.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("resources/iconePack/zoom-in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnZoomIn.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("resources/iconePack/zoom-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnZoomOut.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("resources/iconePack/check-mark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnCheck.setIcon(icon9)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("resources/iconePack/axis_arrow_icon_138909.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnMoveNode.setIcon(icon12)
        font = QtGui.QFont()
        ...
        self.actionbtnGeneralHist = QtWidgets.QAction(MainWindow6)
        self.actionbtnGeneralHist.setCheckable(True)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("resources/iconePack/4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnGeneralHist.setIcon(icon14)
        self.actionbtnGeneralHist.setObjectName("actionbtnGeneralHist")
        self.actionbtnHist1 = QtWidgets.QAction(MainWindow6)
        self.actionbtnHist1.setCheckable(True)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("resources/iconePack/1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnHist1.setIcon(icon15)
        self.actionbtnHist1.setObjectName("actionbtnHist1")
        self.actionbtnHist2 = QtWidgets.QAction(MainWindow6)
        self.actionbtnHist2.setCheckable(True)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("resources/iconePack/2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbtnHist2.setIcon(icon16)
        self.actionbtnHist2.setObjectName("actionbtnHist2")
        self.actionHist3 = QtWidgets.QAction(MainWindow6)
        self.actionHist3.setCheckable(True)
        icon17 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow6):
        ...
        self.actionbtnHome.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">В главное окно</span></p></body></html>"))
        self.actionbtnZoomIn.setText(_translate("MainWindow6", "btnZoomIn"))
        self.actionbtnZoomIn.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Увеличить изображение</span></p></body></html>"))
        self.actionbtnZoomOut.setText(_translate("MainWindow6", "btnZoomOut"))
        self.actionbtnZoomOut.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Уменьшить изображение</span></p></body></html>"))
        ...
        self.actionbtnCheck.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Проверить задание</span></p></body></html>"))
        self.actionbtnInfo.setText(_translate("MainWindow6", "btnInfo"))
        self.actionbtnInfo.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Материалы</span></p></body></html>"))
        self.actionbtnDottedConnectNode.setText(_translate("MainWindow6", "btnDottedConnectNode"))
        self.actionbtnDottedConnectNode.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Расстановка продолжительности работ</span></p></body></html>"))
        self.actionbtnMoveNode.setText(_translate("MainWindow6", "btnMoveNode"))
        self.actionbtnMoveNode.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Переместить вершину</span></p></body></html>"))
        self.actionHelp.setText(_translate("MainWindow6", "подсказка"))
        self.actionHelp.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Решение</span></p></body></html>"))
        ...
        self.actionbtnGeneralHist.setText(_translate("MainWindow6", "General Hist"))
        self.actionbtnGeneralHist.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Общая гистограмма</span></p></body></html>"))
        self.actionbtnHist1.setText(_translate("MainWindow6", "Hist1"))
        self.actionbtnHist1.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">Гистограмма первого подразделения</span></p></body></html>"))
        self.actionbtnHist2.setText(_translate("MainWindow6", "Hist"))
