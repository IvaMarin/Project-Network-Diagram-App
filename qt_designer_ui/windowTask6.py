...
class Ui_MainWindow6(object):
    def setupUi(self, MainWindow6):
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("resources/iconePack/logout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow6):
        ...
        self.actionbtnHome.setToolTip(_translate("MainWindow6", "<html><head/><body><p><span style=\" font-size:14pt;\">В главное меню</span></p></body></html>"))
