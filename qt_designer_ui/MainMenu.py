...
"")
        ...
        self.btnGenVar.setStyleSheet("background-color: #66e3ff;")
        ...
        self.menuFile.addAction(self.actionPrintReport)
        self.menuFile.addAction(self.actionOpenReport)
        self.menuFile.addAction(self.actionactionSaveReportReport_3)
