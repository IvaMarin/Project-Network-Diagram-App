...
class Ui_MainWindow5(object):
    def setupUi(self, MainWindow5):
        ...
        self.actionbtnAddNode.setIcon(icon6)
        ...
        self.actionbtnRemoveNode.setIcon(icon7)
    ...
    def retranslateUi(self, MainWindow5):
        ...
        self.actionbtnAddNode.setToolTip(_translate("MainWindow5", "Добавить последовательность"))
        self.actionbtnRemoveNode.setText(_translate("MainWindow5", "btnRemoveNode"))
        self.actionbtnRemoveNode.setToolTip(_translate("MainWindow5", "Удалить последовательность"))
