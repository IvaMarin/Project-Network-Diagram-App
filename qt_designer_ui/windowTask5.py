...
class Ui_MainWindow5(object):
    ...
    def retranslateUi(self, MainWindow5):
        ...
        self.actionbtnRemoveSeq.setToolTip(_translate("MainWindow5", "Удалить последовательность"))
        self.actionbtnMoveNode.setText(_translate("MainWindow5", "btnMoveNode"))
        self.actionbtnMoveNode.setToolTip(_translate("MainWindow5", "Переместить вершину"))
        self.actionbtnConnectNode.setText(_translate("MainWindow5", "btnConnectNode"))
        self.actionbtnConnectNode.setToolTip(_translate("MainWindow5", "Соединить вершины"))
        ...
        self.actionbtnHome.setToolTip(_translate("MainWindow5", "В главное окно"))
        self.actionbtnRemoveNodeConnection.setText(_translate("MainWindow5", "btnRemoveNodeСonnection"))
        self.actionbtnRemoveNodeConnection.setToolTip(_translate("MainWindow5", "Удалить связь"))
        ...
        self.actionbtnDottedConnectNode.setToolTip(_translate("MainWindow5", "Расстановка продолжительности работ"))
        self.actionHelp.setText(_translate("MainWindow5", "подсказка"))
        self.actionHelp.setToolTip(_translate("MainWindow5", "Решение"))
