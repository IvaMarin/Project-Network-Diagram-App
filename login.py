...
class Ui_login(object):
    def setupUi(self, login):
        ...
        self.gridLayout.addWidget(self.lineEditNumINGroup, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSignLab, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelGroup, 3, 0, 1, 1)
        self.lineEditGroup = QtWidgets.QLineEdit(login)
        self.lineEditGroup.setObjectName("lineEditGroup")
        self.gridLayout.addWidget(self.lineEditGroup, 3, 2, 1, 1)
